 ...
 *
 * A tela em si está no arquivo `04_Formulario.html`.
 *
 ...
 * (isso está no CSS do arquivo `04_Formulario.html`).
 */
function abrirFormularioCmi() {
  var tela = HtmlService.createHtmlOutputFromFile('04_Formulario')
    .setWidth(920)
    .setHeight(720);
