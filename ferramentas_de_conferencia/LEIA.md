...
| `testar_etapa4.js` | Monta as abas com os `.gs` de verdade e roda o formulário: as conferências de célula (extenso, PIA, CNPJ, cabeçalho, lote, assinantes, altura da folha), os PDFs, o `.md`, o Histórico e — desde a Etapa 6 — o **relatório mensal**, inclusive a tabela da contagem que ele aprovou. 759 hoje. |
