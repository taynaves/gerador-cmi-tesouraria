...
```
node ferramentas_de_conferencia/conferir_tela.js  apps_script/04_Formulario.html /tmp
...
| `conferir_tela.js` | Confere `04_Formulario.html`: o JavaScript compila, nenhum `alert`/`confirm`, tags equilibradas, todo `elem('x')` tem um `id="x"`. |
